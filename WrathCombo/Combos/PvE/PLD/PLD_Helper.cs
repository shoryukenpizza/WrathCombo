...
internal partial class PLD
{
    ...
    internal static PLDFRUOpenerMaxLevel1 FRUOpener1 = new();
    internal static WrathOpener Opener()
    {
        if (Opener1.LevelChecked && Config.PLD_SelectedOpener == 0)
            return Opener1;

        if (FRUOpener1.LevelChecked && Config.PLD_SelectedOpener == 1)
            return FRUOpener1;
    ...
    internal class PLDFRUOpenerMaxLevel1 : WrathOpener
    {
        public override List<uint> OpenerActions { get; set; } =
        [
            HolySpirit,
